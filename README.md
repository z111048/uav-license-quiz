...
- **術科測驗模擬器**（無人多旋翼機基本級）：獨立 3D 互動模擬器，可體驗懸停、起降、航點飛行等術科測驗流程；支援自動導航與手動（W/A/S/D / 虛擬搖桿）兩種模式，多視角切換。DJI Phantom 風格無人機模型，具備馬達開機動畫、移動傾斜、起落架、Three.js 陰影等真實視覺效果。於學科練習的設定頁底部入口開啟
